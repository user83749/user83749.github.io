...
<title>Nimbus PPI repository</title>
...
<ol>
<li>In Kodi: <em>Settings &rarr; File manager &rarr; Add source</em> &rarr; <code>{base}/</code></li>
<li><em>Add-ons &rarr; Install from zip file</em> &rarr; the source &rarr;
    <code>{repo_zip_name}</code></li>
